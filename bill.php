...
?>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="text-grey-m2">
                            <div class="my-1">
                            <?php echo $res[0]['cust_house'] ?>,<?php echo $res[0]['cust_city'] ?>
                            </div>
                            <div class="my-1">
                            <?php echo $res[0]['cust_district'] ?>
                            </div>
     ...
     $q="SELECT * FROM `tbl_order` INNER JOIN `tbl_cartmaster` USING (`cart_master_id`)INNER JOIN `tbl_cartchild` USING (cart_master_id) INNER JOIN `tbl_item` USING (item_id) where cust_id='$cid' and cart_master_id='$cmid'  and status='paid'";
     $res=select($q);
     $sino=1;
    ...
    foreach ($res as $row) {
      ?>
     <tr align="center">
 <td><img width="100" height="100" src="<?php echo $row['item_image'] ?>"></td>
